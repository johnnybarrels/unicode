...
Revision ID: 92b68f910ad3
Revises: 
Create Date: 2020-05-26 01:02:36.454809
...
def upgrade():
    ...
    sa.Column('mcq_answer', sa.String(length=8), nullable=True),
    ...
    sa.Column('needs_marking', sa.Boolean(), nullable=False),
    sa.Column('feedback', sa.String(length=1024), nullable=True),
    sa.ForeignKeyConstraint(['test_id'], ['tests.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('output_sub', sa.String(length=128), nullable=True),
    sa.Column('mcq_sub', sa.String(length=8), nullable=True),
    sa.Column('code_sub', sa.String(length=1024), nullable=True),
